...
import { State, getIsUsers, getIsUserProfile, getIsCurrentUserProfile,  getIsSubscriptionsProfile, getIsSubscribersCurrent } from '../../../core/store';
...
export class SearchWrapperComponent implements OnInit {
  ...
  private btnChangeFollow: boolean = true;
  private btnChangeDelete: boolean = false; 
